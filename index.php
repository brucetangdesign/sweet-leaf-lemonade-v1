  ...
  <!-- Google Tag Manager -->
    ...
    <section class="slide-main slide2">
      ...
      <div class="slide-content">
        ...
        <div class="slide-copy rellax" data-rellax-speed="2">
          <h1>Organic Sweet Leaf Tea! We wouldn't make it any other way!</h1>
    ...
    <section class="slide-main slide3">
      ...
      <div class="slide-content">
        ...
        <div class="slide-copy rellax" data-rellax-speed="-2">
          ...
          <p class="subtitle">Born in Austin in Mimi’s kitchen, our original recipe of organic sweet tea still has that flavor only found ‘round here.</p>
    ...
    <section id="about-products" class="slide-main slide4">
      <div class="about-products-main">
        <h1>Our famous organic tea recipes for y’all and all y’alls taste.</h1>
